        ...
        <div className='left'>
          ...
          <div className='botoes'>
            ...
            <div className='botoes_baixo'>
              ...
              <input class="botao botao6 custom-input6" type="number" min="0" max="100" value={customPercentage} onChange={(e) => {setCustomPercentage(Number(e.target.value)); handleCalculate(bill, Number(e.target.value), numberOfPeople);
                }}
              /> 
