      ...
      <div className='main'> {/* as divs da parte principal foram dividias entre a branca(left) e a azul(right) */}
        <div className='left'>
          <div className='input_money'>
            ...
            <input class="count" type="number" placeholder="0" min="0" value={bill} onChange={handleBillChange}></input>
          </div>
          ...
          <div className='botoes'>
            ...
            <div className='botoes_baixo'>
              ...
              <input class="botao botao6 custom-input6" type="number" min="0" max="100" placeholder="CUSTOM"  onChange={(e) => {setCustomPercentage(Number(e.target.value)); handleCalculate(bill, Number(e.target.value), numberOfPeople);
                }}
              /> 
          ...
          <div className='input_money imput_people'>
            ...
            <input class="count" type="number" placeholder="0" min="0" value={numberOfPeople} onChange={handleNumberOfPeopleChange}></input>
          </div>
